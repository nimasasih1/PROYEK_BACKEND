    ...
    <div class="authentication-inner">
      <div class="card">
        <div class="card-body">
          ...
          <h5 class="mb-2" title="Selamat Datang Calon Wisudawan!">Welcome, Future Graduate! 🎓</h5>
          <p class="mb-4" title="Silahkan Masuk ke Akun Anda!">Please sign in to your account!</p>
...
<form method="POST" action="{{ route('login.submit') }}">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="captcha" class="form-control @error('captcha') is-invalid @enderror" 
           placeholder="Enter the text above" title="Masukkan teks captcha di atas">
    @error('captcha')
      <div class="invalid-feedback">{{ $message }}</div>
    @enderror
  </div>
  ...
  @endif
          ...
          <p class="text-center">
            <a href="{{ route('forgot.form') }}" title="Lupa Kata Sandi?"><span>Forgot Password?</span></a>
          </p>

          <p class="text-center">
            <span>New on our platform?</span>
            <a href="{{ route('register.form') }}" title="Buat Akun Baru">
