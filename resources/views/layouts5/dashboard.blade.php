...
<head>
  ...
  <title title="Dasbor CSDL">CSDL Dashboard</title>
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme position-fixed top-0 start-0 h-100">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item {{ request()->is('layouts5/*') ? 'open active' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle" title="Data Mahasiswa">
              <i class="menu-icon tf-icons bx bx-dock-top"></i>
              <div>Student Data</div>
            </a>
            <ul class="menu-sub">
              <li class="menu-item {{ request()->routeIs('layouts5.validation_csdl.index') ? 'active' : '' }}">
                <a href="{{ route('layouts5.validation_csdl.index') }}" class="menu-link" title="Daftar Wisuda">
                  <i class="menu-icon tf-icons bx bx-table"></i>
                  <div>Graduation List</div>
                </a>
              </li>
              <li class="menu-item {{ request()->routeIs('layouts5.pending') ? 'active' : '' }}">
                <a href="{{ route('layouts5.pending') }}" class="menu-link" title="Pending">
