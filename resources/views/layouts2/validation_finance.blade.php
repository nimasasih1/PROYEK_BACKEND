...
<div class="container-fluid">
    <h2 class="mb-4" style="color: #8B0000; font-weight: 600;" title="Data Wisuda - Validasi Selesai">Graduation Data — Validation Complete</h2>
            ...
            <tbody>
                @foreach ($data->unique('id_pendaftaran') as $pendaftaran)
                    ...
                    <tr style="background-color: white;">
                        ...
                        <td style="padding:15px;border:1px solid #dee2e6;">{{ $pendaftaran->catatan_finance ?? '-' }}</td>
                        <td style="text-align:center;padding:15px;border:1px solid #dee2e6;">
                            <span class="badge" title="Validasi keuangan selesai"
                                style="background-color:#28a745;color:white;padding:8px 16px;border-radius:20px;font-weight:500;">
