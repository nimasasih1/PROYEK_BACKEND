        ...
        <table id="wisudaPendingTable" class="table table-bordered" style="width:100%; border-collapse: collapse;">
            <thead style="background-color: #8B0000;">
                <tr>
                    ...
                    <th style="color: white; padding: 12px 15px; text-align: center; font-weight: 600; border: 1px solid #8B0000; white-space: nowrap;">CATATAN PERPUS</th>
                                    ...
                                    <div class="modal-content">
                                        <form action="{{ route('layouts3.validation_perpus.update', $pendaftaran->id_pendaftaran) }}" method="POST">
                                            ...
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="catatanPerpusLabel{{ $pendaftaran->id_pendaftaran }}">Catatan Perpus</h5>
