...
<div class="container-fluid">
    <h2 class="mb-4" style="color: #8B0000; font-weight: 600;">Dashboard Data Wisuda</h2>

    @php
        $totalMahasiswa = $data->count();
        $sudahCeklis = $data->where('is_valid_fakultas', 1)->count();
    ...
    <div class="table-responsive" style="overflow-x: auto; max-width: 100%;">
        <table id="wisudaTable" class="table table-bordered" style="width:100%; border-collapse: collapse;">
            <thead style="background-color: #8B0000;">
                <tr>
                    ...
                    <th style="color: white; padding: 12px 15px; text-align: center; font-weight: 600; border: 1px solid #8B0000; white-space: nowrap;">FAKULTAS</th>
                    <th style="color: white; padding: 12px 15px; text-align: center; font-weight: 600; border: 1px solid #8B0000; white-space: nowrap;">CATATAN FAKULTAS</th>
                ...
                <tr style="background-color: white;">
                    ...
                    <td style="text-align: center; padding: 15px; border: 1px solid #dee2e6;">
                        @if($pendaftaran->is_valid_finance && $pendaftaran->is_valid_perpus && $pendaftaran->is_valid_fakultas && $pendaftaran->is_valid_baak)
                            <span class="badge" style="background-color: #28a745; color: white; padding: 8px 16px; border-radius: 20px; font-weight: 500;">SELESAI</span>
                        @else
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#wisudaTable').DataTable({
            scrollX: true,
            autoWidth: false,
            responsive: false,
            searching: true,
