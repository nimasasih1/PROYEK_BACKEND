...
<head>
  ...
  <title title="Dasbor Fakultas">Faculty Dashboard</title>
          ...
          <li class="menu-item {{ request()->is('layouts4/*') ? 'open active' : '' }}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{ request()->routeIs('layouts4.validation_faculty.index') ? 'active' : '' }}">
                <a href="{{ route('layouts4.validation_faculty.index') }}" class="menu-link" title="Daftar Wisuda">
                  <i class="menu-icon tf-icons bx bx-table"></i>
                  <div>Graduation List</div>
                </a>
              </li>
              <li class="menu-item {{ request()->routeIs('layouts4.pending') ? 'active' : '' }}">
                <a href="{{ route('layouts4.pending') }}" class="menu-link" title="Pending">
