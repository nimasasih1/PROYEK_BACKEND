        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card shadow-sm">
                    <div class="card-header">Student Profile <br><small><em>Profil Mahasiswa</em></small></div>
                    <div class="card-body">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="mt-2 text-muted">Current Profile Photo <em style="display:block; font-size:0.85rem;">Foto Profil Saat Ini</em></p>
                        </div>
                        ...
                        <form action="{{ route('profil_mahasiswa.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            {{-- FIELD UNGGAH FOTO --}}
                            <div class="mb-3">
                                <label for="foto_profil">Upload New Profile Photo <em style="display:block; font-size:0.82rem; color:#888; font-weight:400;">Unggah Foto Profil Baru</em></label>
                                <input
                                    type="file"
                                    id="foto_profil"
                                    name="foto_profil"
                                ...
                                <div class="form-text text-muted">Max 2MB (JPG/JPEG/PNG) — <em>Maksimal 2MB</em></div>
                            ...
                            {{-- FIELD LAINNYA --}}
                            <div class="mb-3">
                                <label>NIM (Login Username) <em style="display:block; font-size:0.82rem; color:#888; font-weight:400;">NIM (Username Login)</em></label>
                                <input type="text" class="form-control" value="{{ $user->username ?? '' }}" readonly>
                                <input type="hidden" name="nim" value="{{ $user->username ?? '' }}">
                            </div>

                            <div class="mb-3">
                                <label>Full Name <em style="display:block; font-size:0.82rem; color:#888; font-weight:400;">Nama Mahasiswa</em></label>
                                <input type="text" name="nama_mahasiswa" class="form-control"
                                    value="{{ old('nama_mahasiswa', $mahasiswa->nama_mahasiswa) }}" required>
                            </div>

                            <div class="mb-3">
                                <label>Education Level <em style="display:block; font-size:0.82rem; color:#888; font-weight:400;">Jenjang Pendidikan</em></label>
                                <select name="jenjang" class="form-select" required>
                                    <option value="" disabled selected>Select Level — Pilih Jenjang</option>
                            ...
                            <div class="mb-3">
                                <label>Faculty <em style="display:block; font-size:0.82rem; color:#888; font-weight:400;">Fakultas</em></label>
                                <select name="fakultas" id="fakultas" class="form-select" required onchange="updateProdi()">
                                    <option value="" disabled {{ empty(old('fakultas', $mahasiswa->fakultas)) ? 'selected' : '' }}>Select Faculty — Pilih Fakultas</option>
                            ...
                            <div class="mb-3">
                                <label>Study Program <em style="display:block; font-size:0.82rem; color:#888; font-weight:400;">Program Studi</em></label>
                                <select name="prodi" id="prodi" class="form-select" required>
                                    <option value="" disabled selected>Select Study Program — Pilih Program Studi</option>
                                </select>
                            </div>

                            <div class="mb-3">
                                <label>Batch Year <em style="display:block; font-size:0.82rem; color:#888; font-weight:400;">Tahun Angkatan</em></label>
                                <select name="tahun" class="form-select" required>
                                    <option value="" disabled selected>Select Year — Pilih Tahun</option>
                            ...
                            <div class="mb-3">
                                <label>Phone Number <em style="display:block; font-size:0.82rem; color:#888; font-weight:400;">No. Telepon</em></label>
                                <input type="text" name="no_telp" class="form-control" value="{{ old('no_telp', $mahasiswa->no_telp) }}">
                            </div>

                            <div class="mb-3">
                                <label>Email <em style="display:block; font-size:0.82rem; color:#888; font-weight:400;">Email</em></label>
<input type="email" id="email" name="email" class="form-control"
    value="{{ old('email', $mahasiswa->email) }}"
    pattern="^[a-zA-Z0-9._%+-]+@(gmail\.com|krw\.horizon\.ac\.id)$"
    title="Email must end with @gmail.com or @krw.horizon.ac.id — Email harus berakhiran @gmail.com atau @krw.horizon.ac.id" required>
                            </div>

                            <div class="mb-3">
                                <label>Address <em style="display:block; font-size:0.82rem; color:#888; font-weight:400;">Alamat</em></label>
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="{{ url('/profil-mahasiswa') }}" class="btn btn-secondary" title="Kembali">← Back</a>
                                <button type="submit" class="btn btn-primary" title="Simpan">Save Changes</button>
                            </div>
                        </form>
    ...
    <script>
        ...
        function updateProdi() {
            ...
            prodiSelect.innerHTML = '<option value="" disabled selected>Select Study Program — Pilih Program Studi</option>';
