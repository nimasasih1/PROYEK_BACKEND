...
Route::middleware(['auth'])->group(function () {
    ...
    // ===============================================
    Route::post('/dashboard/media/store', [DashboardController::class, 'storeMedia'])->name('dashboard.media.store');
    Route::put('/dashboard/media/update/{id}', [DashboardController::class, 'updateMedia'])->name('dashboard.media.update');
    Route::delete('/dashboard/media/destroy/{id}', [DashboardController::class, 'destroyMedia'])->name('dashboard.media.destroy');

    // ===============================================
    // 🎯 ROUTES BARU UNTUK TESTIMONI
    // ===============================================
    Route::post('/dashboard/testimoni/store', [DashboardController::class, 'storeTestimoni'])->name('dashboard.testimoni.store');
    Route::put('/dashboard/testimoni/update/{id}', [DashboardController::class, 'updateTestimoni'])->name('dashboard.testimoni.update');
    Route::delete('/dashboard/testimoni/destroy/{id}', [DashboardController::class, 'destroyTestimoni'])->name('dashboard.testimoni.destroy');
