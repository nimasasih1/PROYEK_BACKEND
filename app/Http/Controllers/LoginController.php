...
class LoginController extends Controller
{
    ...
    return back()->withErrors([
        'error' => 'Error: ' . $e->getMessage()  // ← sementara tampilkan error asli
    ])->withInput($request->only('username'));
}
    }
    public function logout(Request $request)
    {
        try {
            ...
            return redirect()->route('login.form')->with('error', 'Failed to logout, please try again 😭');
        }
    }
    ...
    public function import(Request $request)
    {
        ...
        return back()->with('success_swal', 'Users successfully imported!');
    }
}
