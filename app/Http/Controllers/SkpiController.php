...
class SkpiController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            'tgl_pengajuan_mahasiswa' => 'nullable|date',
        ...
        return redirect()
    ->route('viewmahasiswa.skpi')  // route untuk baak
    ->with('success_swal', 'Data SKPI berhasil diubah!');
    }
